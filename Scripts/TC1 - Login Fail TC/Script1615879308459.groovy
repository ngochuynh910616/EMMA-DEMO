...
WebUI.setEncryptedText(findTestObject('Page_CURA Healthcare Service/input_Password_password'), '+wDuQPYY451ApK/Bw9SXomwWS5hjrGj8')
...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_Username_username'), 'WRONG ID LOGIN')
